...
class BertTextEncoder(nn.Module):
    def __init__(self, use_finetune=False, transformers='bert', pretrained='bert-base-uncased'):
        ...
        self.tokenizer = tokenizer_class.from_pretrained(r'/lc09/qxh/FedDMER/trains/subNets/bert-base-uncased')
        self.model = model_class.from_pretrained(r'/lc09/qxh/FedDMER/trains/subNets/bert-base-uncased')
